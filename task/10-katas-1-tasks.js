        ...
        for (let count = 0; count < 8; count++) {
            switch (count) {
                case 0:
                    ...
                    break;
                case 1:
                    direction = sides[i] + 'b' + sides[i == 3 ? 0 : i + 1];
                    break;
                case 2:
                    direction = sides[i] + btwcardinal;
                    break;
                case 3:
                    direction = btwcardinal + "b" + sides[i];
                    break;
                case 4:
                    direction = btwcardinal;
                    break;
                case 5:
                    direction = btwcardinal + "b" + sides[i == 3 ? 0 : i + 1];
                    break;
                case 6:
                    direction = sides[i == 3 ? 0 : i + 1] + btwcardinal;
                    break;
                case 7:
                    direction = sides[i == 3 ? 0 : i + 1] + "b" + sides[i];
                    break;
            }
