...
function getPokerHandRank(hand) {
    ...
    switch (true) {
        case (isSomeFlush(numberHand)):
            return isInOrderHand(numberHand) ?
                PokerRank.StraightFlush : PokerRank.Flush;
        case (isSomeOfKind(numberHand, 4)):
            return PokerRank.FourOfKind;
        case (isFullHouseOrTwoPairs(numberHand, 3)):
            return PokerRank.FullHouse;
        case (isInOrderHand(numberHand)):
            return PokerRank.Straight;
        case (isSomeOfKind(numberHand, 3)):
            return PokerRank.ThreeOfKind;
        case (isFullHouseOrTwoPairs(numberHand, 2)):
            return PokerRank.TwoPairs;
        case (isSomeOfKind(numberHand, 2)):
